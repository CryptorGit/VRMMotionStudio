<template>
  <div id="menu" ref="menu">
    ...
    <ul id="menu-list" :class="{ hidden: !menuOpen }">
      <li id="import-option" @click="openFile"><i class="fa-solid fa-file-import"></i> 繧､繝ｳ繝昴・繝・/li>
      <li id="export-option" @click="exportPose"><i class="fa-solid fa-file-export"></i> 繧ｨ繧ｯ繧ｹ繝昴・繝・/li>
      <li id="light-option" @click="openSidebarSection('lighting')"><i class="fa-solid fa-lightbulb"></i> 辣ｧ譏手ｨｭ螳・/li>
      <li id="display-option" @click="openSidebarSection('display')"><i class="fa-solid fa-eye"></i> 陦ｨ遉ｺ邂｡逅・/li>
      <li id="physics-option" @click="openSidebarSection('physics')"><i class="fa-solid fa-atom"></i> 迚ｩ逅・ｨｭ螳・/li>
      <li id="morph-option" @click="openSidebarSection('morph')"><i class="fa-solid fa-face-smile"></i> 繝｢繝ｼ繝・/li>
      <li id="models-option" @click="openSidebarSection('models')"><i class="fa-solid fa-list"></i> 繝｢繝・Ν邂｡逅・/li>
      <li id="clear-cache-option" @click="clearCache"><i class="fa-solid fa-trash"></i> 繧ｭ繝｣繝・す繝･蜑企勁</li>
  <li id="toggle-restore" @click="toggleAutoRestore"><i class="fa-solid fa-rotate"></i> 繝｢繝・Ν閾ｪ蜍募ｾｩ蜈・ {{ autoRestore ? 'ON' : 'OFF' }}</li>
    </ul>
  </div>
</template>
