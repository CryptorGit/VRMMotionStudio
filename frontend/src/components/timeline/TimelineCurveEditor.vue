...
// 繝医Λ繝・き繝ｼ蛻・ｊ譖ｿ縺域凾縺ｫ繧ｫ繝ｼ繝悶ｒ菫晏ｭ假ｼ・ｾｩ蜈・ｼ亥ｮ悟・菫ｮ豁｣迚茨ｼ・
watch(() => props.trackerKey, (newTrackerKey, oldTrackerKey) => {
  ...
  // 譌ｧ繝医Λ繝・き繝ｼ縺ｮ繧ｫ繝ｼ繝悶ｒ繧ｿ繧､繝繝ｩ繧､繝ｳ縺ｸ蜊ｳ譎ゆｿ晏ｭ假ｼ医ヨ繝ｩ繝・き繝ｼ蛻・ｊ譖ｿ縺亥燕縺ｮ邱ｨ髮・・螳ｹ繧堤｢ｺ螳溘↓菫晏ｭ假ｼ・
  if (oldTrackerKey && curvesState.value.size > 0) {
    const updatesToEmit = []
    
    curvesState.value.forEach((curve, frameId) => {
      // 繧ｿ繧､繝繝ｩ繧､繝ｳ縺ｸ蜿肴丐縺吶ｋ縺溘ａ縺ｮ譖ｴ譁ｰ繝ｪ繧ｹ繝医↓霑ｽ蜉
      updatesToEmit.push({ keyframeId: frameId, curve: cloneCurve(curve) })
    })

    // 譌ｧ繝医Λ繝・き繝ｼ蛛ｴ縺ｮ繧ｫ繝ｼ繝悶ｒ繧ｿ繧､繝繝ｩ繧､繝ｳ縺ｸ蜊ｳ譎ょ渚譏
  ...
  // 譁ｰ縺励＞繝医Λ繝・き繝ｼ縺ｮ繧ｫ繝ｼ繝悶ｒ蠕ｩ蜈・ｼ医ち繧､繝繝ｩ繧､繝ｳ縺九ｉ逶ｴ謗･蜿門ｾ暦ｼ・
  const next = new Map()
  props.frames.forEach(frame => {
    // 繧ｿ繧､繝繝ｩ繧､繝ｳ縺九ｉ隧ｲ蠖薙ヨ繝ｩ繝・き繝ｼ縺ｮ繧ｫ繝ｼ繝悶ｒ蜿門ｾ・
    const trackerCurve = frame.curves?.[newTrackerKey]?.curve
    
    if (trackerCurve) {
      // 繝医Λ繝・き繝ｼ蟆ら畑縺ｮ繧ｫ繝ｼ繝悶′蟄伜惠縺吶ｋ蝣ｴ蜷医・縺昴ｌ繧剃ｽｿ逕ｨ
      ...
      // 繝医Λ繝・き繝ｼ蟆ら畑繧ｫ繝ｼ繝悶′縺ｪ縺・ｴ蜷医・default繧ｫ繝ｼ繝悶ｒ繧ｳ繝斐・・域眠隕上ヨ繝ｩ繝・き繝ｼ縺ｮ蝣ｴ蜷茨ｼ・
      ...
      // default繝医Λ繝・き繝ｼ閾ｪ霄ｫ縺ｮ蝣ｴ蜷医・default繧ｫ繝ｼ繝悶∪縺溘・繝輔Ξ繝ｼ繝縺ｮ繧ｫ繝ｼ繝悶ｒ菴ｿ逕ｨ
...
watch(
  ...
  frames => {
    ...
    frames.forEach(frame => {
      // 譌｢蟄倥・迥ｶ諷九ｒ蜆ｪ蜈育噪縺ｫ菴ｿ逕ｨ・育ｷｨ髮・憾諷九ｒ菫晄戟・・
...
watch(() => props.curveColor, () => {
  // 繧ｫ繝ｼ繝冶牡縺悟､峨ｏ縺｣縺ｦ繧ゅき繝ｼ繝冶・菴薙・邯ｭ謖・
}, { immediate: false })
